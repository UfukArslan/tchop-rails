...
Restaurant.create(name: 'Hotel de la couronne', description: 'Brasserie', city_id: 1)
...
Restaurant.create(name: 'Pizzeria Chez Maurice', description: 'Traiteur régional', city_id: 3)
